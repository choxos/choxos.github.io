...
| Item | Details |
|---|---|
| Protocol version | 3.0, draft for review (round 3) |
...
Phase 2, pilot (from 19 September 2026 to the study start): checks of the reminders, the automatic data flows, the backups and the evening log. Pilot reports test the software and never enter a model; the software fits no model at all until the study start is set.
